        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    <li class="nav-item">
                        <router-link :to="{name: 'Dashboard'}" class="nav-link" exact-active-class="active"  active-class="active">
                    ...
                    <li class="nav-item"  v-if="$store.getters.HAS_ANY_ACCESS(['users','users.create','users.update', 'users.block', 'users.unblock'])">
                        <router-link :to="{name: 'Users'}" class="nav-link" exact-active-class="active"  active-class="active">
                    ...
                    <li class="nav-item" v-if="$store.getters.HAS_ANY_ACCESS(['tenants','tenants.create','tenants.update', 'tenants.block', 'tenants.unblock'])">
                        <router-link :to="{name: 'Tenants'}" class="nav-link" active-class="active">
                    ...
                    <li class="nav-item" v-if="$store.getters.HAS_ANY_ACCESS(['units'])">
                    ...
                    <li class="nav-item" v-if="$store.getters.HAS_ANY_ACCESS(['settings'])">
