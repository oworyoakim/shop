...
class Branch extends Model
{
    ...
    {
        return $this->overallSales()->whereDate('transact_date', $date);
    }
    ...
    {
        return $this->canceledSales()->whereDate('transact_date', $date);
    }
    ...
    {
        return $this->payables()->whereDate('transact_date', $date);
    }
